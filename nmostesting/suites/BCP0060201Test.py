...
class BCP0060201Test(GenericTest):
    ...
    def test_02(self, test):
        ...
        try:
            ...
            h264_flows = [flow for flow in self.is04_resources["flows"] if flow["format"] == "urn:x-nmos:format:video"
    ...
    def test_04(self, test):
        ...
        try:
            ...
            h264_senders = [sender for sender in self.is04_resources["senders"] if sender["flow_id"]
    ...
    def test_06(self, test):
        ...
        try:
            h264_receivers = [receiver for receiver in self.is04_resources["receivers"]
    ...
    def test_07(self, test):
        ...
        enum_constraints = {
            ...
            "urn:x-nmos:cap:format:constant_bit_rate": h264_properties["constant_bit_rate"]["enum"],
